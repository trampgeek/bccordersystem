...
|
*/
$config['base_url'] = 'http://www.ctc.org.nz/bcc/';
...
*/
$config['joomla_base_url'] = "http://www.ctc.org.nz";

// Flag to allow hacked-up running of this code on my laptop (rjl)
$config['laptop'] = False; // True on laptop only
...
| contact roles taken from the Joomla contact_details table.
| Currently (May 2008) the only roles with full access are webmaster,
| dbadmin, secretary and treasurer.
 */
$config['full_access_roles'] = array('webmaster','dbadmin','secretary','treasurer');
